...
const Navbar = () => {
  ...
  const LogoSymbol = () => (
    isAkatsuki ? (
      // Premium Akatsuki Red Cloud with inner shadows and glowing outlines
      ...
      // Premium Konoha Leaf Symbol in 3D gold/orange gradient
      <svg className="h-9 w-9 text-orange-500 filter drop-shadow-[0_0_8px_rgba(249,115,22,0.8)]" viewBox="0 0 24 24" fill="none" stroke="url(#konohaLeafGrad)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
        <defs>
          <linearGradient id="konohaLeafGrad" x1="0%" y1="0%" x2="100%" y2="100%">
  ...
  const HeadbandIcon = () => (
    <svg className="h-6 w-6 filter drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]" viewBox="0 0 24 24" fill="none">
      ...
      {isAkatsuki && <line x1="6" y1="12" x2="18" y2="12" stroke="#c8102e" strokeWidth="1" />} {/* Slashed rogue headband */}
    </svg>
  );
    ...
    <>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 hidden md:block transition-colors duration-500 ${
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Shinobi Styled Resource Counters (Designed like premium gaming status indicators) */}
          <div className="flex items-center gap-4 lg:gap-6">
            ...
            >
              <div className="flex flex-col flex-1 text-left leading-none justify-center">
                <span className="text-[7px] text-slate-400 uppercase tracking-wider">Missions</span>
                <span className="text-yellow-400 font-bold text-[10px] mt-0.5">8+ S-RANK</span>
              </div>
            ...
            {/* Chakra Sage EXP progress capsule */}
            <div 
            ...
            >
              <div className="flex flex-col flex-1 text-left leading-none justify-center">
                <span className="text-[7px] text-slate-400 uppercase tracking-wider">Chakra Exp</span>
                <span className="text-sky-400 font-bold text-[10px] mt-0.5">3 YRS+ Sage</span>
            ...
            >
              <div className="flex flex-col flex-1 text-left leading-none justify-center">
                <span className="text-[7px] text-slate-400 uppercase tracking-wider">Active Jutsu</span>
            ...
            >
              <div className="flex flex-col flex-1 text-left leading-none justify-center">
                <span className="text-[7px] text-emerald-400 font-bold uppercase tracking-wider animate-pulse">Summon Pact</span>
                <span className="text-white font-bold text-[10px] mt-0.5">RECRUIT SAGE</span>
              </div>
      ...
      <div className={`fixed top-0 left-0 right-0 z-50 md:hidden flex justify-between items-center px-4 py-2 border-b transition-colors duration-500 ${
        ...
        <div className="flex items-center gap-2 cursor-pointer select-none" onClick={handleLogoClick}>
          <LogoSymbol />
          <span className="font-coc text-xs text-white">SOUMYA'S NINDO</span>
        </div>
